...
const GooglePayImage = '/assets/images/googlepay.svg';
const AppStoreImage = '/assets/images/app-store.svg';
const AppImage = '/assets/images/app-img.png';
const MobileImage = '/assets/images/mobile-app.png';
export default function DownloadApp() {
  return (
    <div className={styles.downlodApp}>
      <div className='container-md'>
        <div className={styles.box}>
          <div className={styles.contentAlignment}>
            ...
            <p>
              Turn your free time into crypto rewards with fun, skill-based games you can play anytime, anywhere. Our app lets you dive into exciting gameplay
              and earn real tokens with every win.
            </p>
